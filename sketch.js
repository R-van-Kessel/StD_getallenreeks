...
function generateQuestions() {
    ...
    // ============================================
    // AANPASBAAR: Voeg hier nieuwe reekstypen toe of verwijder bestaande
    // ============================================
    const sequenceTypes = [
        {
            name: "Driehoeksgetallen",
            generate: (n) => (n * (n + 1)) / 2, // 0, 1, 3, 6, 10, 15...
            length: 5  // AANPASBAAR: aantal getallen in de reeks voor de vraag
        },
        {
            name: "Kwadraten",
            generate: (n) => (n + 1) * (n + 1), // 1, 4, 9, 16, 25...
            length: 4  // AANPASBAAR: aantal getallen in de reeks voor de vraag
        },
        {
            name: "Machten van 2",
            generate: (n) => Math.pow(2, n), // 1, 2, 4, 8, 16...
            length: 5
        },
        {
            name: "Fibonacci",
        ...
        {
            name: "Oneven getallen",
            generate: (n) => 2 * n + 1, // 1, 3, 5, 7, 9...
            length: 5
        },
        {
            name: "Kubussen",
            generate: (n) => (n + 1) * (n + 1) * (n + 1), // 1, 8, 27, 64, 125...
            length: 4
        },
        {
            name: "Stap +3",
            generate: (n) => 2 + n * 3, // 2, 5, 8, 11, 14...
            length: 5
        },
        {
            name: "Stap +5",
            generate: (n) => 3 + n * 5, // 3, 8, 13, 18, 23...
            length: 5
        },
        {
            name: "Verdubbelen +1",
            generate: (n) => Math.pow(2, n) - 1, // 0, 1, 3, 7, 15...
            length: 5
        },
        {
            name: "Driehoek x2",
            generate: (n) => n * (n + 1), // 0, 2, 6, 12, 20...
            length: 5
        }
        // AANPASBAAR: Voeg hier meer reekstypen toe in dezelfde vorm
        // {
        //     name: "Jouw reeks naam",
        //     generate: (n) => n * 2, // bijvoorbeeld: 0, 2, 4, 6, 8...
        //     length: 5
        // }
    ];
    
    // ============================================
    // AANPASBAAR: Aantal vragen (standaard 10)
    // ============================================
    for (let i = 0; i < 10; i++) {
        // Getallenreeks
        let sequenceType = random(sequenceTypes);
        
        // ============================================
        // NIEUW: Varieer de startpositie en vraagpositie
        // ============================================
        
        // Bepaal waar in de reeks we beginnen (0 tot 3)
        let startOffset = floor(random(0, 4));
        
        // Bepaal waar het vraagteken komt (begin, midden, of eind)
        let questionPosition = floor(random(3));
        // 0 = begin, 1 = midden, 2 = eind
        ...
        if (questionPosition === 0) {
            ...
            // Vraagteken in het MIDDEN: 1-3-?-10-15
            let midPoint = floor(sequenceType.length / 2);
            ...
            // Vraagteken aan het EIND: 3-6-10-15-?
